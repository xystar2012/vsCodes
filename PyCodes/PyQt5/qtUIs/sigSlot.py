...
class SignalEmit(QWidget):
    ...
    def initUI(self):           
        ...
        self.previewSignal[int,str].connect(self.on_previewPaperWithArgs)  
        self.printButton.clicked.connect(self.emitPrintSignal)
        self.previewButton.clicked.connect(self.on_PreviewSignal)
    ...
    def on_previewPaperWithArgs(self,style,text):
